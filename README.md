...
Since I'm keeping track of my own solutions to the nanodegree projects at this repo (https://github.com/sclark2006/dl-nanodegree-exercises), this fork is only to make contributions to the base nanodegree reposository.
